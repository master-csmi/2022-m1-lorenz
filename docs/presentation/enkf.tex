...
\begin{frame}[allowframebreaks]{Kalman filter}
 ...
 \end{aligned}\right.$$
    ...
    \begin{figure}
    	\pgfimage[width=0.5\linewidth]{images/enkf/schema_kalman_filter.png}
    \end{figure}
\end{frame}
\begin{frame}{Minimizing a cost function}
	...
	\begin{minipage}{\linewidth}
		\centering
		\pgfimage[width=0.6\linewidth]{images/enkf/schema_3D_Var.png}
	\end{minipage}
\end{frame}
...
%\begin{frame}[allowframebreaks]{Harmonic oscillator}
    ...
    %\begin{enumerate}[\textbullet]
		...
		%\item For the discretisation,  $dt$=$\frac{Pe}{20}$ 
		%\item We try to find the solution in the interval $[0,T]$ with T=$3Pe$
   	%\end{enumerate}
...
\begin{frame}{Harmonic oscillator}
	...
	%\begin{figure}[H]
		%\includegraphics[width=0.32\linewidth]{"images/enkf/oscillator1.png"}
		%\includegraphics[width=0.32\linewidth]{"images/enkf/oscillator2.png"}
		%\includegraphics[width=0.32\linewidth]{"images/enkf/oscillator3.png"}
	%\end{figure}
