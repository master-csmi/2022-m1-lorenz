...
\begin{figure}[H]
    \centering
		\includegraphics[width=0.4\textwidth]{"images/oscillator1.png"}
		\includegraphics[width=0.4\textwidth]{"images/oscillator2.png"}
		\includegraphics[width=0.4\textwidth]{"images/oscillator3.png"}
...
\noindent\newline Let's take 
 ...
 \begin{figure}[H]
    \centering
		\includegraphics[width=1\textwidth]{"images/lorenz2_a.png"}
...
\noindent\newline Let's take 
 ...
 \begin{figure}[H]
        \centering
		\includegraphics[width=1\textwidth]{"images/lorenz3_b.png"}
